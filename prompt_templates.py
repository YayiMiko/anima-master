...
- 常规输出 65-75 个互不重复、可见、可生成的内容 tags，最多不得超过 80 个。画面元素单薄时，应优先补充服装结构、动作细节、道具互动、轮廓光和少量设计元素，而不是堆叠同义词。
...
- 输出前先删除互相冲突的构图、光影、天气和画风 tags，并合并含义高度相近的氛围词。Tag 按以下优先级排列：用户明确要求、主体动作与关键物件、服装、神态、构图、背景、光影与特效、氛围与画风。越重要的内容越靠前。
