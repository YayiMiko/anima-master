...
def parse_hard_route(text: str) -> tuple[str, str] | None:
    ...
    for prefix in prefixes:
        ...
        action_map = [
            ...
            ("查看画师预设", "list_artist_presets"),
            ("查看画师组", "list_artist_presets"),
            ("列出画师预设", "list_artist_presets"),
            ("列出画师组", "list_artist_presets"),
            ("画师预设列表", "list_artist_presets"),
            ("画师组列表", "list_artist_presets"),
            ("使用画师预设", "use_artist_preset"),
            ("使用画师组", "use_artist_preset"),
            ("启用画师预设", "use_artist_preset"),
            ("启用画师组", "use_artist_preset"),
            ("切换画师预设", "use_artist_preset"),
            ("切换画师组", "use_artist_preset"),
            ("选择画师预设", "use_artist_preset"),
            ("选择画师组", "use_artist_preset"),
            ("删除画师预设", "delete_artist_preset"),
            ("删除画师组", "delete_artist_preset"),
            ("移除画师预设", "delete_artist_preset"),
            ("移除画师组", "delete_artist_preset"),
            ("设置画师预设", "set_artist_tags"),
            ("设置画师组", "set_artist_tags"),
            ("设置新的画师预设", "set_artist_tags"),
            ("设置新的画师组", "set_artist_tags"),
            ("新建画师预设", "create_artist_preset"),
            ("新建画师组", "create_artist_preset"),
            ("新建新的画师预设", "create_artist_preset"),
            ("新建新的画师组", "create_artist_preset"),
            ("创建画师预设", "create_artist_preset"),
            ("创建画师组", "create_artist_preset"),
            ("创建新的画师预设", "create_artist_preset"),
            ("创建新的画师组", "create_artist_preset"),
            ("创建新画师预设", "create_artist_preset"),
            ("创建新画师组", "create_artist_preset"),
            ("保存画师预设", "create_artist_preset"),
            ("保存画师组", "create_artist_preset"),
            ("保存新的画师预设", "create_artist_preset"),
            ("保存新的画师组", "create_artist_preset"),
            ("画师预设", "set_artist_tags"),
            ("画师组", "set_artist_tags"),
            ("追加画师预设", "append_artist_tags"),
            ("追加画师组", "append_artist_tags"),
            ("添加画师预设", "append_artist_tags"),
            ("添加画师组", "append_artist_tags"),
            ("加入画师预设", "append_artist_tags"),
            ("加入画师组", "append_artist_tags"),
            ("加入新的画师预设", "append_artist_tags"),
