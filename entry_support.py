...
class EntrySupportMixin:
    ...
    async def initialize(self):
        ...
        logger.info(
            "[comfyui_agent] chiyo_profile=%s img2img_enabled=%s edit_tool_changed=%s remove_bg_tool_changed=%s base_url=%s workflow=%s",
    ...
    async def _generate(
        ...
        if (
            ...
            and not final.passed
            and not final.skipped
        ):
